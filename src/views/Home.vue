        ...
        <div class="row">
          <div class="col">
            <select class="form-select" v-model="ordenacao">
              ...
              <option value="4">De Z - A</option> <!--utilizando localeCompare-->
            </select>
          </div>
...
export default {
  ...
  watch: {
    ordenacao(valorNovo) {
      ...
      //método sort
      //return 1 para indicar que ordem está correta
      ...
      if(valorNovo == 1) { //ordenação por id crescente
        this.pokemons.sort((proximo, atual) => {
          ...
          //console.log('proximo', proximo.id)
          //console.log('--------------------')
      ...
      if(valorNovo == 4 ) { //Ordenação alfabética de Z - A (utilizando - localeCompare)
        this.pokemons.sort((proximo, atual) => {
  ...
  methods: {
    ...
    removerHabilidade(indice) {
      if(this.pokemon.habilidades[indice]) {
        //console.log('remover o índice: ', indice)
